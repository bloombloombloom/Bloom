...
namespace Widgets
{
    CurrentItem::CurrentItem(const Targets::TargetMemoryBuffer& registerValue, QWidget* parent)
        : Item(registerValue, parent)
    {
        this->setObjectName("current-item");
        this->setFixedHeight(30);
        this->titleLabel->setText("Current Value");
        this->layout->addWidget(this->titleLabel, 0, Qt::AlignmentFlag::AlignLeft);
